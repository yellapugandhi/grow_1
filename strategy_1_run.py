...
if page == "📈 Live Signal":
    def live_predict(symbol="NSE-NIFTY", interval_minutes=10):
        ...
        if isinstance(data, dict) and 'candles' in data and len(data['candles']) > 0:
            ...
            if confidence >= 90:
                strength = "🔥 Strong BUY"; color = "green"
            elif confidence >= 70:
                strength = "✅ Moderate BUY"; color = "green"
            elif confidence >= 50:
                strength = "⚠️ Weak BUY"; color = "orange"
            elif confidence >= 30:
                strength = "⚠️ Weak SELL"; color = "orange"
            elif confidence >= 10:
                strength = "❌ Moderate SELL"; color = "red"
            else:
                strength = "☠️ Strong SELL"; color = "darkred"
